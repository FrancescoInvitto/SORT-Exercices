...
{
  printf("Nome: %s, Prezzo unitario: %d, Prezzo minimo: %d, Quantita:%d, Tipo: %d, Ricavo: %d, Sockfd: %d, Fine lista: %d\n", item.nome, item.prezzo_unitario, item.prezzo_minimo, item.quantita, item.tipo, item.ricavo, item.sockfd, item.fine_lista);
}
