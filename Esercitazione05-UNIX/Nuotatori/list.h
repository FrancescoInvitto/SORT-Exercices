...
#define TIPO_MAESTRO 0
#define TIPO_NUOTATORE 1
#define N 12	//numero di fasce orarie
...
typedef struct
{
  int pid;
  int orario;
  int num_ore;	//significativo solo per il maestro, contiene il numero di orari in cui è disponibile. Per il nuotatore è banalmente posto a 1 (un nuotatore richiede 1 lezione)
  int tipo;
  int sockfd;  
}
  itemType;
