...
{
  printf("Nome: %s, Partite giocate: %d, Punteggio totale: %d, Posizione: %d, Numero giocatore: %d, Sockfd: %d\n", item.nome, item.num_partite, item.punteggio, item.posizione, item.num_giocatore, item.sockfd);
}
